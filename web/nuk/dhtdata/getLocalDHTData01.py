...
#http://localhost:8088/bigdata/dhtdata/dht2jsonwithdate.php?MAC=3C71BFFD882C&start=20210101&end=20211231
#可以用下面SQL語法，進行擷取筆數
# select  MAC, count(*) as cnt from dhtdata  where 1 group by MAC  order by MAC

url1 = "http://localhost:8088/bigdata/dhtdata/dht2jsonwithdate.php?MAC=%s&start=%s&end=%s"
