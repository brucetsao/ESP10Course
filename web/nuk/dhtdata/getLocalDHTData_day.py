...
y1data=[]
y2data=[]
#http://localhost:8088/bigdata/dhtdata/dht2jsonwithday.php?MAC=CC50E3B5BB20&start=20220101&end=20220131
#可以用下面SQL語法，進行擷取筆數
# select  MAC, count(*) as cnt from dhtdata  where 1 group by MAC  order by MAC

url1 = "http://localhost:8088/bigdata/dhtdata/dht2jsonwithday.php?MAC=%s&start=%s&end=%s"
