...
#http://localhost:8088/fcu/dhtdata/dht2json.php?MAC=246F289E48D4&start=20210101&end=20211231
url1="http://localhost:8088/fcu/dhtdata/dht2json.php?MAC=%s&start=%s&end=%s"
