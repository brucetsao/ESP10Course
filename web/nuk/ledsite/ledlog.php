...
<body>
    ...
    <form action="lightlog.php" method="POST" name="form1" target="_self" id="form1">
        <table align="center">
            <tr>
                <td width="24%">編號</td>
            ...
            <tr>
                <td width="24%">是否刪除光明燈資料</td></td>
                <td width="76%">
                <input type="checkbox" name="ck1" id="ck1" value="1" checked="checked">
                 <label for="ck1">刪除光明燈資料</label>   
                </td>
            </tr>                                   
            <tr>
                <td width="24%">是否複寫光明燈歷史資料</td></td>
                <td width="76%">
                <input type="checkbox" name="ck2" id="ck2" value="1" checked="checked">
                 <label for="ck2">複寫光明燈歷史資料</label> 
                </td>
            </tr>                                   
            <tr>
                <td width="24%">年度</td>
                <td width="76%"><label for="textfield"></label>
                    <input type="text" name="year" id="year" value="<?php echo getThisYear();?>"/>
                </td>
            </tr> 
            <tr>
            ...
            <tr>
                <td colspan="2" align="center"><input type="reset" name="button" id="button" value="重設" />
                    <input type="submit" name="button2" id="button2" value="光明燈轉入歷史資料" />
                </td>
            </tr>
        </table>
