...
$goddata = "<tr><td>%s<input type='hidden' name='sn[]' value='%s'/></td><td>%s<input type='hidden' name='mid[]' value='%s'/><input type='hidden' name='name[]' value='%s'/></td><td><div align = 'center'><img src='/fcu/images/meatball/%s' width='80' height='80' /></div></td><td>%s<input type='hidden' name='price[]' value='%s'/></td><td><input type='number' name='number[]' value='%s'></td></tr>\n" ;
...
foreach($_SESSION['itemlist'] as $x)
{
 ...
 //   {
		...
		$goddatastr = sprintf($goddata,$x[0],$x[0],$row["name"],$x[1],$row["name"],$row["pic"],$row["price"],$row["price"],$x[2]) ;
        echo $goddatastr;
 //   }
  //  echo "---------------<br>" ;
...
<div align='center'><input type='submit' name='button' id='button' value='結帳' /></div>
