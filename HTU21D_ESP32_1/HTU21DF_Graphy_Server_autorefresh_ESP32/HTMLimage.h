...
String humidunitimg = "percent.jpg" ;
...
String imagefile2HTML(String nn)
{
...
String GetTempwithHTML()
{
  String t1,t2,t3 ;
  t1 = imagefile2HTML(tempimg) ;
  t2 = Number2Image(String(Temp_Value)) ;
  t3 = imagefile2HTML(tempunitimg) ;
  
 return t1+t2+t3 ; 
}

String GetHumidwithHTML()
{
  String t1,t2,t3 ;
  t1 = imagefile2HTML(humidimg) ;
  t2 = Number2Image(String(Humid_Value)) ;
  t3 = imagefile2HTML(humidunitimg) ;
