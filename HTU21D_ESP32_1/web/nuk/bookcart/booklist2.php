...
$subform = "<form method='POST' action='addcart.php?book_no=%s&book_name=%s&price=%d'>\n";
$subrow = "<tr bgcolor='white' height='30' align='center'><td>%s</td><td>%s</td><td>%d</td><td><input type='number' name='quantity' size='5' value='1' min='1' max='5'></td><td><input type='submit' value='放入購物車'></td></tr>\n" ;	
$subformend = "</form>\n";
