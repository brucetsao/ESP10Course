...
<?php
	...
	if ($count >0)      //有資料
	{
       ...
       echo "<tr class='tablehead'><td>序</td><td>城市代碼</td><td>城市名稱</td></tr>" ;  
       //印出表格抬頭
       //$row0 = "<tr><td>1</td><td>01</td><td>南投縣</td></tr>" ;
       $rowdata = "<tr class='tablehead1'><td>%s</td><td><div id = 'a%d'>%s</div></td><td>%s<a href='#top'><img src = '../images/sstop.png'></a></td></tr>" ;
        //第一階 城市資料的列格式套表字串
