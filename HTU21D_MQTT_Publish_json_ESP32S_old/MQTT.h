...
/*
#define MQTTServer "www.iot.ncnu.edu.tw" 
#define MQTTPort 1883
char* MQTTUser = "power412";  // 不須帳密
char* MQTTPassword = "ncnueeai";    // 不須帳密
*/
...
void fillTopic(String mm)
{
  ...
  sprintf(SubTopicbuffer,SubTop,mm.c_str()) ;
   ...
   // PubTopic[len(PubTopic.length()+1] = '\n' ;
  //  SubTopic[SubTopic.length()+1] = '\n' ;
