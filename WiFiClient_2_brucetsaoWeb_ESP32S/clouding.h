...
String strGet="GET ncnu.arduino.org.tw";
//  DB Agent 程式
...
//http://ncnu.arduino.org.tw/brucetsao/index.php
// host is  ==>ncnu.arduino.org.tw:80

void SendtoClouding()     //傳送感測資料到雲端
{
//http://ncnu.arduino.org.tw/brucetsao/index.php
// host is  ==>ncnu.arduino.org.tw:80
//  app program is ==> /brucetsao/index.php
         ...
         if (client.connect(iotserver, iotport)) //  client.connect(iotserver, iotport)＝＝＞連線到雲端主機
         {
                 ...
                 //### Send to Server
                 String strHttpGet = strGet + strHttp;
