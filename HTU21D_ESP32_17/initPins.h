...
int debug = 1   ;   //0->不顯示debug，1->顯示debug
...
void debugmsg(int msg) ; //傳送訊息到debug 介面
void debugmsg(float msg) ; //傳送訊息到debug 介面
void debugmsg(double msg) ; //傳送訊息到debug 介面
void debugmsg(char msg) ; //傳送訊息到debug 介面

void debugmsgln(String msg) ; //傳送訊息到debug 介面，並換行
void debugmsgln(int msg) ; //傳送訊息到debug 介面，並換行
void debugmsgln(float msg) ; //傳送訊息到debug 介面，並換行
void debugmsgln(double msg) ; //傳送訊息到debug 介面，並換行
void debugmsgln(char msg) ; //傳送訊息到debug 介面，並換行
